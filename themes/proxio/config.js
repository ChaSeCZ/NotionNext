...
PROXIO_BLOG_LINK_4 : '/category/故事记录' , // 填写您的第四个分类链接
  ...
  PROXIO_CAREERS: [
    {
      title: '参军入伍',
      bio: '2016-2018',
      text: '熟练使用81，95式等枪械，熟悉单兵作战，听党指挥，能打胜仗，作风优良！',
    },
    {
      title: '大学生涯',
      bio: '2018-2022',
      text: '辩论赛亚军，辩论赛冠军，赴美带薪优秀者，校级社团创始人（成功从学校赚取经费供大家XXX）',
    },
    {
      title: '狠狠赚钱',
      bio: '2022-Now',
  ...
  PROXIO_ABOUT_TEXT_2:
    '悠悠岁月少年狂，五味杂陈冠笄苦。凡事摧眉折腰事事忌惮，只为心中之人上下安好。只可惜这世间不如意事十之有九，与人说者无有二三。若是这人间重走一遭，定要<br/>醉里江南醒时雪，<br/>月散乘风夜不归。<br/>执剑但去莫负问，<br/>踏马横江斩不平。',
  PROXIO_ABOUT_PHOTO_URL: '/images/IMG_3756.jpeg',
